...
<html lang="en" class="no-focus">
    <head>
        ...
        <title>Nuevo Registro | Tramite Documentario</title>
    </head>
    <body>
            ...
            <main id="main-container">
                ...
                <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Nuevo Registro <small></small></h3>
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Listado de Documentos <small>Tramite Documentario</small></h3>
                        </div>
                        <div class="block-content block-content-full">
